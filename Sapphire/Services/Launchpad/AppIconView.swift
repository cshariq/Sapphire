...
class LaunchpadViewModel: ObservableObject {
    ...
    private var allApps: [SystemApp] = []; private let appFetcher = SystemAppFetcher(); private var settingsModel = SettingsModel.shared; private var cancellables = Set<AnyCancellable>()
