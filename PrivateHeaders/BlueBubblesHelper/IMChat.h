...
+ (void)updateVIPChatIdentifiers:(id)arg1;
...
- (void)_updateChatItemsAsNotSpamEnumeratingItems:(id)arg1;
...
- (id)_insertHistoricalMessages:(id)arg1 queryID:(NSString*)arg2 isRefresh:(BOOL)arg3 isHistoryQuery:(BOOL)arg4 limit:(unsigned long long)arg5 hasMessagesBefore:(BOOL)arg6 hasMessagesAfter:(BOOL)arg7;
...
- (NSString*)loadMessagesBeforeAndAfterGUID:(id)arg1 numberOfMessagesToLoadBeforeGUID:(unsigned long long)arg2 numberOfMessagesToLoadAfterGUID:(unsigned long long)arg3 loadImmediately:(BOOL)arg4;
- (NSString*)loadMessagesUpToGUID:(id)arg1 date:(id)arg2 limit:(unsigned long long)arg3 loadImmediately:(BOOL)arg4;
- (NSString*)loadMessagesBeforeDate:(id)arg1 limit:(unsigned long long)arg2 loadImmediately:(BOOL)arg3;
- (NSString*)loadMessagesBeforeDate:(id)arg1 limit:(unsigned long long)arg2;
- (NSString*)loadMessagesUpToGUID:(id)arg1 limit:(unsigned long long)arg2;
