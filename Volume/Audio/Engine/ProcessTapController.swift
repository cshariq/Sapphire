...
//
// The nonisolated(unsafe) annotation marks vintelligencebles that cross the thread boundary.
...
final class ProcessTapController: ProcessTapControlling {
    ...
    //
    // These vintelligencebles are accessed from CoreAudio's real-time thread without locks.
    ...
    /// state (correct peak level, EQ processors, volume vintelligenceble, crossfade curve).
    ///
